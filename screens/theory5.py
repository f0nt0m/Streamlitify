...
class TheoryScreen5(BaseScreen):
    def __init__(self, page, app):
        super().__init__(page, app)
        self.theory_title = ft.Text("Deploying on Other Platforms", size=30, weight=ft.FontWeight.BOLD)
    ...
    def load_theory_content(self):
        with open("text/theory.json", "r") as file:
            theory_data = json.load(file)["theory5"]
